/*
	...
	byte code management, writted by Florian Kr?ch, Copyright (C) 2004 .
...
namespace SwfDotNet.IO.Tags 
{
	...
	public class DefineBitsJpeg3Tag : DefineBitsJpeg2Tag 
    {
		...
		/// </summary>
		/// <param name="fileName">Name of the file.</param>
        public new void DecompileToFile(string fileName)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public new Image DecompileToImage()
        {
        ...
        {
            using (InflaterInputStream stream = new InflaterInputStream(new MemoryStream(Bytes)))
            {
